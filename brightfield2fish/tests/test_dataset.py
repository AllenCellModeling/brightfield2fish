...
def test_FishDataframeDatasetTIFF(channel_content="MYL2", split="valid", data="fake"):
    ...
    dset = FishDataframeDatasetTIFF(csv_path, channel_content=channel_content, csv=True)
